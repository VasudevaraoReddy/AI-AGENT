    ...
    <div className="min-h-screen bg-[#333333] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-[#cccccc] mb-8 max-w-3xl mx-auto">
              Your intelligent cloud computing assistant. Get expert guidance, smart recommendations, and seamless provisioning across multiple cloud platforms.
            </p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#333333] p-6 rounded-lg text-white">
              ...
              <p className="text-[#cccccc]">Seamlessly manage and deploy across AWS, Azure, and GCP platforms.</p>
            </div>
            ...
            <div className="bg-[#333333] p-6 rounded-lg text-white">
              ...
              <p className="text-[#cccccc]">Get personalized service recommendations based on your needs.</p>
            </div>
            ...
            <div className="bg-[#333333] p-6 rounded-lg text-white">
              ...
              <p className="text-[#cccccc]">Automated infrastructure deployment with best practices.</p>
            </div>
            ...
            <div className="bg-[#333333] p-6 rounded-lg text-white">
              ...
              <p className="text-[#cccccc]">Interact with your cloud infrastructure using natural language.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#cccccc]">Describe your cloud needs in natural language</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#cccccc]">Receive tailored cloud service suggestions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Deploy & Manage</h3>
              <p className="text-[#cccccc]">Automatically provision and manage your infrastructure</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#ffffff] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-8 text-[#333333]">Ready to Transform Your Cloud Experience?</h2>
          <button
            onClick={() => navigate('/login')}
            className="bg-[#ffe600] text-[#333333] px-8 py-3 rounded-lg font-semibold hover:bg-[#ffe600]/90 transition-colors duration-200"
          >
